  ...
  return (
    <div className="space-y-5 max-w-2xl mx-auto">
      ...
      >
        ...
        <p className="text-sm text-foreground/75 leading-relaxed">{data.warning}</p>
      </motion.div>
      ...
      <div className="space-y-4">
        {data.items.map((item, idx) => (
          <motion.div
            ...
            className="rounded-2xl bg-card border border-border/50 hover:border-border/80 transition-colors p-5 md:p-6"
          >
      ...
      {data.notes && (
        ...
        >
          <p className="text-sm text-foreground/75 leading-relaxed">{data.notes}</p>
        </motion.div>
      )}
