...
export const metadata = {
  title: 'Hitung Zakat Online (Maal, Fitrah, Perdagangan, Pertanian, Peternakan) — Jadda',
  ...
  openGraph: {
    title: 'Hitung Zakat Online Lengkap — Jadda',
  ...
  return (
    <>
      <BreadcrumbJsonLd items={[
        ...
        { name: 'Hitung Zakat', url: `${baseUrl}/zakat` },
      ]} />
      <FAQJsonLd faqs={[
