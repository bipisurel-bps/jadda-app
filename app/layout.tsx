...
export const metadata = {
  ...
  description: 'Jadda — Aplikasi Islami ringkas berbahasa Indonesia: jadwal sholat, arah kiblat (kompas), 310 doa harian dari Hisnul Muslim, 42 Hadits Arbain An-Nawawi, Kitab Riyadhus Shalihin, kalkulator zakat (maal, fitrah, perdagangan, pertanian, peternakan), kalkulator waris (faraidh), dan panduan umrah & haji lengkap sesuai Al-Quran dan Sunnah.',
  keywords: ['doa harian islam', 'hisnul muslim', 'hadits arbain', 'riyadhus shalihin', 'riyadhus sholihin', 'kalkulator zakat', 'kalkulator waris', 'faraidh', 'panduan umrah', 'panduan haji', 'arah kiblat', 'qibla compass', 'kompas kiblat', 'jadwal sholat', 'aplikasi islami', 'jadda', 'dzikir pagi petang', 'doa sehari-hari'],
