  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="text-sm text-muted-foreground mt-1">Informasi tentang Doa & Waris</p>
      </motion.div>
      ...
      <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="rounded-xl bg-card border border-border/50 p-6 shadow-sm">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="font-display font-bold text-lg text-foreground">Doa & Waris</h2>
        </div>
        <p className="text-sm text-foreground/80 leading-relaxed mb-3">
          <strong>Doa & Waris</strong> adalah aplikasi web (PWA) yang dirancang untuk membantu umat Islam dalam dua hal penting:
        </p>
        <ul className="space-y-3">
          <li className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Kumpulan doa dari kitab Hisnul Muslim karya Sa&apos;id bin Ali bin Wahf Al-Qahtani, mencakup 110 kategori dengan 211 doa lengkap — teks Arab, transliterasi Latin, terjemahan Indonesia, dan sumber hadits.</p>
            </div>
          </li>
          <li className="flex items-start gap-3">
