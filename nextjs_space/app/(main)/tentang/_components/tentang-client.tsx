        ...
        <ul className="space-y-3">
          <li className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Kumpulan 15 kategori doa dari kitab Hisnul Muslim karya Said bin Ali bin Wahf Al-Qahthani, lengkap dengan teks Arab, transliterasi Latin, terjemahan Indonesia, dan sumber hadits.</p>
            </div>
          </li>
          <li className="flex items-start gap-3">
