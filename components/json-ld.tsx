...
export function WebsiteJsonLd({ baseUrl }: { baseUrl: string }) {
  const data = {
    ...
    url: baseUrl,
    description:
      'Jadda — Aplikasi Islami ringkas berbahasa Indonesia: jadwal waktu sholat otomatis, arah kiblat (kompas digital), pengingat dzikir pagi petang, 310 doa harian dari Hisnul Muslim, 42 Hadits Arbain An-Nawawi, Kitab Riyadhus Shalihin, kalkulator zakat & waris (faraidh), panduan umrah dan haji lengkap sesuai Al-Quran dan Sunnah.',
    ...
    featureList: [
      ...
      '42 Hadits Arbain An-Nawawi dan Ibnu Rajab + Kitab Riyadhus Shalihin (372 bab)',
    ...
    keywords: 'jadwal sholat, waktu adzan, arah kiblat, qibla, kompas kiblat, doa harian islam, hisnul muslim, hadits arbain, riyadhus shalihin, kalkulator zakat, kalkulator waris faraidh, panduan umrah, panduan haji, aplikasi islami, dzikir pagi petang',
  };
